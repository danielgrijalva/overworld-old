...
describe('Test <Form />', () => {
  ...
  it('renders Username FormField', () => {
    ...
    expect(usernameInput.props().onChange.getMockName()).toEqual('handleChangeMock');
  });
  ...
  it('calls handleChange when username field is updated', () => {
    ...
    usernameInput.simulate('change', {target: {name: 'username', value: 'name'}} );
  ...
  it('renders Password FormField', () => {
    ...
    expect(passwordInput.props().onChange.getMockName()).toEqual('handleChangeMock');
  });
