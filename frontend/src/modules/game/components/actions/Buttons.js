...
class Buttons extends React.Component {
  ...
  onClick = (e, { value }) => {
    const { id, name, slug, cover } = this.props.game;
    switch (value) {
      case "played":
        this.props.logGame(id, name, slug, cover.image_id);
        break;
      case "liked":
        this.props.likeGame(id, name, slug, cover.image_id);
        break;
      case "backlog":
        this.props.addToBacklog(id, name, slug, cover.image_id);
        break;
      case "wishlist":
        this.props.addToWishlist(id, name, slug, cover.image_id);
        break;
      default:
        break;
    }
